...
class EmployeeUpdate(LoginRequiredMixin,UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        employee.cluster=ML(clusterable_text)
        employee.save()
        return response
...
class Job_PostUpdate(LoginRequiredMixin,UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        post.cluster=ML(clusterable_text)
        post.save()
        return response
...
class CourseUpdate(LoginRequiredMixin,UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        response = super().form_valid(form)
        course   = self.object
        jobDescription  = course.jobDescription
        clusterable_text = preprocess(jobDescription)
        course.clusterable_text = clusterable_text
        course.cluster=ML(clusterable_text)
        course.save()
        return response
